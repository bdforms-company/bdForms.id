    ...
    <div className="bd relative flex min-h-screen flex-col items-center px-4 pt-20">
      ...
      <div className="glass w-full max-w-md rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button type="submit" disabled={loading} className="flex w-full items-center justify-center gap-2 rounded-xl py-3 font-bold shadow-md transition hover:-translate-y-0.5 disabled:translate-y-0 disabled:opacity-50" style={{ background: "var(--primary)", color: "var(--on-primary)" }}>
        ...
        <p className="mt-6 text-center text-sm" style={{ color: "var(--on-surface-variant)" }}>Belum punya akun? <Link href="/auth/signup" className="font-semibold" style={{ color: "var(--primary)" }}>Daftar sekarang</Link></p>
      </div>
    </div>
  );
}
